...
namespace Dotend.MBTrade
{
    ...
    public class MBTAPI
    {
        ...
        private MBTAPI(string pPrivateKey, string pPublicKey, string pPin)
        {
        ...
        public string Error
            ...
            private bool validateJsonReturn(string pJson)
            {
                ...
                {
                    var _data = JsonConvert.DeserializeObject<Dictionary<string, object>>(pJson); //new Dictionary<string, object>();JavaScriptSerializer().DeserializeObject(pJson);
                    ...
                    if (_data != null)
                    {
                        if (((Dictionary<string, object>)_data).ContainsKey("status_code"))
                        {
                            ...
                            {
                                _codeError = Convert.ToInt32(((Dictionary<string, object>)_data)["status_code"]);
